<?php
    ...
    $section = "inventario"; //variable para identificar la seccion o pagina en que se esta
            ...
            <tbody>
                <?php foreach ($datosProductos as $key => $value) {
                    ...
                    echo '<tr>
                            ...
                            <td>' . $value["stock"] . '</td>
                            <td>
                                <a href="editar_producto.php?editarProducto&codigo='.$value["cod_producto"].'" class="btn btn-primary"><i class="fas fa-edit"></i></a>
